# ⚠️ DRIFTED — original design doc, NOT current truth. For live facts (auth, scheduler, AI providers, schema) read `.claude/invariants.md`; conflicts there win. Kept for historical/design context.
